...
import { Search, Filter, Grid, List, ChevronDown, X, ShoppingBag, Sparkles } from "lucide-react";
        ...
        <div className="space-y-2 max-h-48 overflow-y-auto">
          {brands.map((br) => (
            <div key={br} className="flex items-center space-x-3">
              ...
              />
              <Label htmlFor={`br-${br}`} className="text-sm cursor-pointer">
                {br}
              </Label>
            </div>
          ))}
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <Input
            ...
            className="pl-12 pr-4 py-3 text-lg border-2 border-gray-200 focus:border-blue-400 bg-white/80 backdrop-blur-sm"
          />
        </div>
      </div>
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center justify-between mb-6 p-4 bg-white/80 backdrop-blur-sm rounded-lg shadow-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex border rounded-md bg-white/50">
                <Button
