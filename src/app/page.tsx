...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <div className="container mx-auto px-4 py-4 flex flex-col lg:flex-row gap-6">
        <div className="w-full lg:w-64 hidden lg:block">
          <Card><CardContent><FilterContent /></CardContent></Card>
        </div>
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-4">
            <Sheet>
              <SheetTrigger asChild>
                <Button variant="outline" className="lg:hidden"><Filter /> Filters</Button>
              </SheetTrigger>
              <SheetContent side="left">
                <SheetHeader><SheetTitle>Filters</SheetTitle><SheetDescription>Filter products</SheetDescription></SheetHeader>
                <FilterContent />
              </SheetContent>
            </Sheet>
            ...
            <div className="flex gap-2">
              <Button variant={viewMode === "grid" ? "default" : "ghost"} onClick={() => setViewMode("grid")}><Grid /></Button>
              <Button variant={viewMode === "list" ? "default" : "ghost"} onClick={() => setViewMode("list")}><List /></Button>
            </div>
          </div>
            ...
            <Card>
              <CardContent className="text-center p-16">
                ...
                {suggestions.length > 0 && (
                  <div className="mt-8">
                    <h3 className="text-lg font-semibold mb-4">Suggestions you might like:</h3>
                    <div className={`grid ${viewMode === "grid" ? "grid-cols-1 sm:grid-cols-2 xl:grid-cols-3" : "grid-cols-1"} gap-6`}>
